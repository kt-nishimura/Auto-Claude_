        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="text-lg font-semibold">{t('ideation.generatingIdeas')}</h2>
              <Badge variant="outline">
                {completedCount}/{enabledTypes.length} {t('ideation.complete')}
              </Badge>
            </div>
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              {showLogs ? t('ideation.hideLogs') : t('ideation.showLogs')}
            </Button>
            <Tooltip>
              <TooltipTrigger asChild>
                ...
                >
                  ...
                  {isStopping ? t('ideation.stopping') : t('ideation.stop')}
                </Button>
              </TooltipTrigger>
              <TooltipContent>{t('ideation.stopGeneration')}</TooltipContent>
            </Tooltip>
          </div>
        </div>
