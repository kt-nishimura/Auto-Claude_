...
export function InsightsModelSelector({
  ...
  const getDisplayText = () => {
    ...
    return profile?.name || t('insights.balanced');
  };
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-64">
          <DropdownMenuLabel>{t('insights.agentProfile')}</DropdownMenuLabel>
          ...
          >
            ...
            <div className="flex-1">
              <div className="font-medium">{t('insights.custom')}</div>
              <div className="text-xs text-muted-foreground">
                {t('insights.customDesc')}
              </div>
            </div>
